...
jest.mock('../app/api/WeatherForecastAPI');
...
import * as WeatherForecastAPI from '../app/api/WeatherForecastAPI';
...
describe('Test actions - weatherLoaded()', () => {
	it ('should call the dispatcher', () => {
		// Calling 'weatherloaded()' should dispatch an action. We can verify this
		// by making sure that the "Dispatch" was called
		const weather = [];
